class GraduatesController < ApplicationController
  ...
  def create
    ...
    @graduate.user = current_user if current_user.role == 'user'

    respond_to do |format|
      if @graduate.save
        format.html { redirect_to new_graduate_requesit_path, notice: 'Graduate was successfully created.' }
  ...
  private
    ...
    def graduate_params
      params.require(:graduate).permit(:lastname, :name, :second_name, :status, :doc_adress, :post_adress, :phone, :email, :user_id)
    end
end
